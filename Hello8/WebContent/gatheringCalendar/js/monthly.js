...
(function ($) {
	...
	$.fn.extend({
		...
		function addEvent(event, setMonth, setYear) {
			...
			var fullStartDate = _getEventDetail(event, "ggdate"),
			...
			var eventContent = _getEventDetail(event, "gcontent"),
				eventTitle = _getEventDetail(event, "gsubject"),
				eventClass = _getEventDetail(event, "class"),
				eventColor = _getEventDetail(event, "color"),
				eventId = _getEventDetail(event, "gno"),
			...
			var	markupDayStart = dayStartTag
				...
				markupListEvent = "<a"
					...
					+ attr("title", eventTitle)
					+ ">" +"<h3>"+ eventTitle + "(" +fullStartDate+")"+"</h3>"+ "<br>" 
					+ eventContent + "</a>";
