...
<table><caption>Update Form</caption>
	<tr><th>Subject</th><td><textarea rows="1" cols="50" 
    	name="fquestion" required="required">${faq.fquestion}</textarea></td></tr>
    <tr><th>Content</th><td><pre><textarea rows="30" cols="50" 
    	name="fanswer" required="required"  id="editor1">${faq.fanswer}
    	</textarea>
    	<script>
